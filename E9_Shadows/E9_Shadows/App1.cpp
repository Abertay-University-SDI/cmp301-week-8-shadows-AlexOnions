...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in, bool VSYNC, bool FULL_SCREEN)
{
	...
	orthoMesh = new OrthoMesh(renderer->getDevice(), renderer->getDeviceContext(), screenWidth / 2, screenHeight / 2, screenWidth / 1.5, screenHeight / 1.5);
...
void App1::gui()
{
	...
	ImGui::SliderFloat3("LightPosition", pos, -20, 20);
